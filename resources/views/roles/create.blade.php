...
@section('content')
    ...
    <section class="card" style="width: min(100%, 820px);">
        <div class="stack">
            <div>
                <h1 style="margin: 0 0 0.35rem; font-size: 1.75rem;">Yeni Rol</h1>
                <p class="muted" style="margin: 0;">Rol adı belirleyin ve bu role ait aksiyon izinlerini seçin.</p>
            </div>
            ...
            <form method="POST" action="{{ url('/roles') }}" class="stack">
                @csrf
                ...
                <div style="display: flex; gap: 0.75rem; flex-wrap: wrap;">
                    <button class="button" type="submit">Rolü Kaydet</button>
